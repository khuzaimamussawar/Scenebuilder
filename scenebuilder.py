...
<style>
    ...
    .stApp { background-color: #111827; color: #e2e8f0; }
    
    /* Inputs & Text Areas - gray-800 */
...
def call_gemini(payload, model_type="text"):
    ...
    if model_type == "image":
        ...
        # Text - Use 1.5 Flash if 2.5 is blocked in EU
    ...
    for i, key in enumerate(keys):
        try:
            ...
            if res.status_code == 429: 
                ...
                continue
            # Check for Geo-Block (400/404) on text models and fallback
            if res.status_code in [400, 404] and model_type == "text":
                 fb_url = "[https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent](https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent)"
...
# --- STEP 4: SCENE BUILDER ---
    ...
    with st.container(border=True):
        ...
        with col_ref:
            ...
            # UPLOAD REF (FIXED DUPLICATION BUG)
